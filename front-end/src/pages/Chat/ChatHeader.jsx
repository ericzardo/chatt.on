...
ChatHeader.propTypes = {
  ...
  toggleChatSidebarOpen: PropTypes.func.isRequired,
  toggleChatInfosOpen: PropTypes.func.isRequired,
};

function ChatHeader ({ chatName, toggleChatSidebarOpen, toggleChatInfosOpen }) {
  ...
  return (
    ...
    <div className="sticky top-0 left-0 flex w-full justify-between items-center px-6 py-2 dark:bg-zinc-950/20 bg-zinc-300/80">
      <span className="flex gap-3 justify-between items-center">
        ...
        <ArrowLeft onClick={toggleChatSidebarOpen} className="dark:text-zinc-400 text-zinc-600 hover:dark:text-zinc-300 hover:text-zinc-800 cursor-pointer" />
      ...
      <span className="flex gap-3 items-center dark:text-zinc-400 text-zinc-600">
        ...
        <Users onClick={toggleChatInfosOpen} className="cursor-pointer hover:dark:text-zinc-300 hover:text-zinc-800" />
      </span>
